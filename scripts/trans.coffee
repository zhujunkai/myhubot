# Description:
#   Returns the string of the trans for a query
#
# Dependencies:
#   None
#
...
#
# Commands:
#   hubot trans me <query> - transs <query> & returns 1st result's string
#
# Author:
#   searls

module.exports = (robot) ->
  robot.respond /(trans)( me)? (.*)/i, (msg) ->
    transMe(msg,msg.match[3])

transMe = (msg, query) ->
  from = 'en'
  to = 'zh'
  appid = '20190317000277994'
  salt = '1435660288' 
  key = 'v_y65WachQ1WK8J7gUSM'
  str1 = '20190317000277994' + query + '1435660288' +'v_y65WachQ1WK8J7gUSM'
  sign = MD5(str1)
  q =
    q: query,
    from: from,
    ...
    salt: salt,
    sign: sign
  msg.http('http://api.fanyi.baidu.com/api/trans/vip/translate')
    .query(q)
    .get() (err, res, body) ->
      json = JSON.parse(body)
      switch res.statusCode                                
        when 200
          msg.send "Answer: #{json.trans_result[0].dst}"
        else
